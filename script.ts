document.addEventListener("DOMContentLoaded", function () {
  ...
  if (botaoTerror) botaoTerror.addEventListener("click", mostrarListaTerror);
  if (botaoAcao) botaoAcao.addEventListener("click", mostrarListaAcao);
  if (botaoFiccao) botaoFiccao.addEventListener("click", mostrarListaFiccao);
  if (botaoRomance) botaoRomance.addEventListener("click", mostrarListaRomance);
  if (botaoComedia) botaoComedia.addEventListener("click", mostrarListaComedia);
  if (botaoDrama) botaoDrama.addEventListener("click", mostrarListaDrama);
  ...
  function mostrarLivros(lista: string[]) {
    const divLista = document.getElementById("listaLivros") as HTMLElement | null;
    if (!divLista) {
